...
in
{
  ...
  # Startup applications (uncomment and add entries as needed)
  # xdg.autostart.entries = {
  #   slack = { name = "Slack"; exec = "slack"; };
  #   signal = { name = "Signal"; exec = "signal-desktop"; };
  #   1password = { name = "1Password"; exec = "1password"; };
  # };
}
